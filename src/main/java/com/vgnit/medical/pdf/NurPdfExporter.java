...
public class NurPdfExporter {

    private List<Nur> listNurses;

    public NurPdfExporter(List<Nur> listNurses) {
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        document.open();
        document.add(new Paragraph("LIST OF NURSES"));
